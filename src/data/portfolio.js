...
export const portfolio = {
  ...
  languages: {
    en: {
      brandAriaLabel: 'Go to the home section',
      actions: {
      ...
      about: {
        ...
        stats: [
          ...
          { value: '100%', label: 'Editable template' },
        ],
      },
      skills: {
        eyebrow: 'Skills',
        title: 'Tools you can replace as you grow.',
        groups: [
          {
            icon: 'Code2',
            title: 'Frontend',
          ...
          },
          {
            icon: 'Sparkles',
            title: 'Creative edge',
            items: ['UI details', 'Color systems', 'Micro-interactions', 'Problem framing'],
          },
        ],
      },
      projects: {
        eyebrow: 'Projects',
        title: 'Placeholder projects for your next work.',
        intro:
          'These cards are ready for real projects later. Think of them as empty display cases: the shape is already there, and you only need to place your best work inside.',
        actionAriaLabel: 'Project links',
        items: [
          {
            title: 'Project One',
    ...
    es: {
      brandAriaLabel: 'Ir a la seccion de inicio',
      actions: {
        language: 'Cambiar idioma',
        menu: 'Abrir o cerrar navegacion',
      ...
      projects: {
        ...
        items: [
          {
            title: 'Proyecto Uno',
            description: 'Reemplaza esto con un proyecto escolar, una app personal o un experimento que te guste.',
            tag: 'Web App',
            image: 'images/project-placeholder-1.svg',
            imageAlt: 'Captura placeholder para Proyecto Uno',
            githubUrl: '#',
            demoUrl: '#',
          },
          {
            title: 'Proyecto Dos',
            description: 'Agrega el problema, tu rol, las herramientas que usaste y lo que aprendiste.',
            tag: 'React',
            image: 'images/project-placeholder-2.svg',
            imageAlt: 'Captura placeholder para Proyecto Dos',
            githubUrl: '#',
            demoUrl: '#',
          },
          {
            title: 'Proyecto Tres',
            description: 'Despues puedes usar una captura para que las visitas entiendan rapido el proyecto.',
            tag: 'Trabajo escolar',
            image: 'images/project-placeholder-3.svg',
            imageAlt: 'Captura placeholder para Proyecto Tres',
            githubUrl: '#',
            demoUrl: '#',
          },
        ],
